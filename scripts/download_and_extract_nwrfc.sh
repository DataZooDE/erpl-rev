...
# Download and extract the NW RFC SDK (same mechanism as DataZooDE/erpl).
SRC=${1:-'s3://erpl-resources/sapnwrfc/nwrfc750P_13-70002752_linux.zip'}
TARGET=${2:-'./nwrfcsdk/linux/'}
